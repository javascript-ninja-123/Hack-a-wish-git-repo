...
class MainProfile extends Component {
  ...
  render() {
    const { kidProfile: { results: { fullname, illness, age, longProfile, moneyRaised, thumbnailSrc, goal, donors }, isLoading, }, closeProfile, percentage } = this.props;
    ...
    return (<Fragment>
      <Grid>
        <Grid.Column style={{ minWidth: '625px', width: '75%' }}>
          <ProfileStatsWrapper >
            <ProfileStats heartbeats={heartbeats} moneyRaised={moneyRaised} donors={donors} />
          </ProfileStatsWrapper>
          <Progress style={{ height: 'auto', color: 'black' }} size='medium' percent={percentage} indicating success progress active>
      ...
      <ProfileSegment style={{ minWidth: '625px', width: '75%' }}>
        <Grid columns={2} relaxed='very'>
          <Grid.Column width={9}>
            ...
            <ProfileImage style={{ cursor: 'pointer' }} onClick={() => closeProfile()}
          ...
          <Grid.Column style={{ marginTop: '20px', marginLeft: '150px' }} width={2}>
            <Grid.Row>
              <Button.Group>
